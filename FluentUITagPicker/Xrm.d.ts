...
declare namespace XrmBase {
    ...
    interface UserPrivilege {
        /**
         * Specifies if the user can read data values for the attribute.
         */
        canRead: boolean;
        /**
         * Specifies if the user can update data values for the attribute.
         */
        canUpdate: boolean;
        /**
         * Specifies if the user can create data values for the attribute.
         */
        canCreate: boolean;
    }
    ...
    interface ExecutionContext<T extends PageBase<AttributeCollectionBase, TabCollectionBase, ControlCollectionBase, QuickViewFormCollectionBase>> {
        /**
    ...
    interface SaveEventArgs extends EventArgs {
        /**
    ...
    interface PageTab<T extends SectionCollectionBase> {
         ...
         */
        getParent(): UiModule<Collection<PageTab<Collection<PageSection>>>, Collection<BaseControl>, Collection<QuickViewFormControl>>;
     ...
     */
    interface UiModule<T extends TabCollectionBase, U extends ControlCollectionBase, V extends QuickViewFormCollectionBase> {
        /**
     ...
     */
    interface PageBase<T extends AttributeCollectionBase, U extends TabCollectionBase, V extends ControlCollectionBase, W extends QuickViewFormCollectionBase> {
        /**
         * Data on the page.
         */
        data: DataModule<T>;
     ...
     */
    interface BasicPage extends PageBase<AttributeCollection, TabCollection, ControlCollection, QuickViewFormCollectionBase> {
        /**
 ...
 */
interface XrmBase<T extends XrmBase.PageBase<XrmBase.AttributeCollectionBase, XrmBase.TabCollectionBase, XrmBase.ControlCollectionBase, XrmBase.QuickViewFormCollectionBase>> extends BaseXrm {
    /**
...
declare const Xrm: BaseXrm;

declare namespace XrmBase {
    var Page: PageBase<AttributeCollectionBase, TabCollectionBase, ControlCollectionBase, QuickViewFormCollectionBase>;
    /**
     * Interface for the base of an XrmBase.Page
     */
    interface PageBase<T extends AttributeCollectionBase, U extends TabCollectionBase, V extends ControlCollectionBase, W extends QuickViewFormCollectionBase> {
...
declare namespace XrmBase {
    ...
    interface Utility {
         ...
         * @param parameters A dictionary object that passes extra query string parameters to the form. Invalid query string parameters will cause an error.
         */
        openQuickCreate(entityLogicalName: string, createFromEntity?: Lookup, parameters?: any): PromiseLike<any>;
    }
}
...
declare namespace XrmBase {
    ...
    type PageType = "entitylist" | "webresource" | "entityrecord" | "custom" | "dashboard";
    ...
    interface PageInput {
         ...
         */
        createFromEntity?: XrmBase.EntityReference<string>;

        /**
         * Id of the entity to open
         */
        entityId?: string;
    ...
    interface Navigation {
         ...
         */
        openFile(file: File, openFileOptions?: OpenFileOptions): void;
    ...
    interface RetrieveMultipleResponse extends WebApiResponse {
        /**
         * An array of the returned entities. 
         */
        entities: Array<any>;

        /**
         * The URL containing the next set of records in the collection
         */
        nextLink: string;
    }
    ...
    interface ProcessModule {
         ...
         */
        addOnPreProcessStatusChange(handler: (context?: ExecutionContext<any>) => any): void;
         ...
         */
        removeOnPreProcessStatusChange(handler: (context?: ExecutionContext<any>) => any): void;
         ...
         * This client API is only supported on the Unified Client. The legacy web client does not support this client API.
         */
        addOnPreStageChange(handler: (context?: ExecutionContext<any>) => any): void;
         ...
         */
        removeOnPreStageChange(handler: (context?: ExecutionContext<any>) => any): void;
    }
    ...
    interface UiModule<T extends TabCollectionBase, U extends ControlCollectionBase, V extends QuickViewFormCollectionBase> {
        ...
        /**
         * Access to the quick forms associated with the current form.
         */
        quickForms: V;
    }
    ...
    interface App {
        /**
         * Adds a global notification to the app.
         * @param notification
         */
         ...
         * @param uniqueId
         */
        clearGlobalNotification(uniqueId: string): void;
    ...
    interface AppSidePanes {
         ...
         * @param paneOptions
         */
        createPane(paneOptions: PaneOptions): PromiseLike<AppSidePane>;
         ...
         * @param panelId
         */
        getPane(panelId: string): AppSidePane;
    ...
    interface AppSidePane {
         ...
         */
        navigate(options: PageInput): void;
    }
    ...
    interface QuickViewFormCollectionBase extends CollectionBase<QuickViewFormControl> {
    }

    interface QuickViewFormControl {
        /** Gets the control on a form. */
        getControl(control: string | number): BaseControl;
...
declare namespace XrmBase {
    ...
    interface UiModule<T extends TabCollectionBase, U extends ControlCollectionBase, V extends QuickViewFormCollectionBase> {
        /**
         * Section containing the header items.
         */
        headerSection: HeaderSection;

        /**
         * Section containing the footer items.
         */
    ...
    interface FooterSection {
        /**
         * Gets the visibility of the footer.
         */
        getVisible(): boolean;
    ...
    type PageTabContentType = "cardSections" | "singleComponent";

    interface PageTab<T extends SectionCollectionBase> {
        /**
         * Returns the content type.
         */
        getContentType(): PageTabContentType;

        /**
         * Sets the content type.
         * @param contentType
         */
        setContentType(contentType: PageTabContentType): void;
    }
}
